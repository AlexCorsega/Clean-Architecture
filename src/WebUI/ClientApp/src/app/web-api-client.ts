...
export interface ITagClient {
    getUniqueTags(todoListId: number | undefined): Observable<TagBriefDto[]>;
    create(command: CreateTagCommand): Observable<number>;
    getMostUsedTags(): Observable<TagBriefDto[]>;
...
export class TagClient implements ITagClient {
    ...
    getUniqueTags(todoListId: number | undefined): Observable<TagBriefDto[]> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetUniqueTags(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetUniqueTags(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<TagBriefDto[]>;
                }
            } else
                return _observableThrow(response_) as any as Observable<TagBriefDto[]>;
        }));
    }

    protected processGetUniqueTags(response: HttpResponseBase): Observable<TagBriefDto[]> {
        ...
        if (status === 200) {
            ...
            if (Array.isArray(resultData200)) {
                ...
                for (let item of resultData200)
                    result200!.push(TagBriefDto.fromJS(item));
            }
            else {
                result200 = <any>null;
            }
    ...
    getMostUsedTags(): Observable<TagBriefDto[]> {
        let url_ = this.baseUrl + "/api/Tag/GetMostUsedTags";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetMostUsedTags(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetMostUsedTags(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<TagBriefDto[]>;
                }
            } else
    ...
    protected processGetMostUsedTags(response: HttpResponseBase): Observable<TagBriefDto[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
...
export interface ITodoItemsClient {
    ...
    search(title: string | null | undefined, listId: number | undefined): Observable<TodoItemDto[]>;
    filterTodoItemsByTag(name: string | null | undefined, listId: number | undefined): Observable<TodoItemDto[]>;
    ...
    updateItemBackground(id: number | undefined, command: UpdateBackgroundTodoItemCommand): Observable<FileResponse>;
}
...
export class TodoItemsClient implements ITodoItemsClient {
    ...
    search(title: string | null | undefined, listId: number | undefined): Observable<TodoItemDto[]> {
        let url_ = this.baseUrl + "/api/TodoItems/Search?";
    ...
    protected processSearch(response: HttpResponseBase): Observable<TodoItemDto[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
    ...
    filterTodoItemsByTag(name: string | null | undefined, listId: number | undefined): Observable<TodoItemDto[]> {
        let url_ = this.baseUrl + "/api/TodoItems/FilterTodoItemsByTag?";
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processFilterTodoItemsByTag(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processFilterTodoItemsByTag(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<TodoItemDto[]>;
                }
            } else
    ...
    protected processFilterTodoItemsByTag(response: HttpResponseBase): Observable<TodoItemDto[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
    ...
    updateItemBackground(id: number | undefined, command: UpdateBackgroundTodoItemCommand): Observable<FileResponse> {
        let url_ = this.baseUrl + "/api/TodoItems/UpdateItemBackground?";
        if (id === null)
            throw new Error("The parameter 'id' cannot be null.");
        else if (id !== undefined)
            url_ += "id=" + encodeURIComponent("" + id) + "&";
        ...
        return this.http.request("put", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processUpdateItemBackground(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processUpdateItemBackground(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<FileResponse>;
                }
            } else
    ...
    protected processUpdateItemBackground(response: HttpResponseBase): Observable<FileResponse> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
...
export class TagBriefDto implements ITagBriefDto {
    id?: number;
    name?: string;

    constructor(data?: ITagBriefDto) {
        if (data) {
    ...
    static fromJS(data: any): TagBriefDto {
        data = typeof data === 'object' ? data : {};
        let result = new TagBriefDto();
        result.init(data);
        return result;
    }
...
export class UpdateBackgroundTodoItemCommand implements IUpdateBackgroundTodoItemCommand {
    id?: number;
    colour?: string;

    constructor(data?: IUpdateBackgroundTodoItemCommand) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): UpdateBackgroundTodoItemCommand {
        data = typeof data === 'object' ? data : {};
        let result = new UpdateBackgroundTodoItemCommand();
        result.init(data);
        return result;
    }
...
export interface IUpdateBackgroundTodoItemCommand {
    id?: number;
    colour?: string;
}
